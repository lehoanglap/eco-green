/*! Pickr 1.7.4 MIT | https://github.com/Simonwep/pickr */ ! function (t, e) {
    ...
    return function (t) {
        ...
        function _(t, e, o, n) {
            e /= 100, o /= 100;
            return [...y(255 * (1 - d(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - d(1, e * (1 - n) + n)), 255 * (1 - d(1, o * (1 - n) + n)))]
        }
                        ...
                        return ((t, e, o) => {
                            ...
                            for (const t of v) {
                                ...
                                if (!(n < p || n + s > c))
                                    for (const s of b) {
                                        const c = d[(o ? "v" : "h") + s];
                                        if (!(c < f || c + a > l)) return e.style[r] = c - u[r] + "px", e.style[i] = n - u[i] + "px", t + s
                                    }
                            }
        ...
        class B {
            constructor(t) {
                j(this, "_initializingActive", !0), j(this, "_recalc", !0), j(this, "_nanopop", null), j(this, "_root", null), j(this, "_color", k()), j(this, "_lastColor", k()), j(this, "_swatchColors", []), j(this, "_eventListener", {
                    init: [],
                    save: [],
                    hide: [],
                    show: [],
        ...
        j(B, "utils", n), j(B, "version", h.a), j(B, "I18N_DEFAULTS", {
